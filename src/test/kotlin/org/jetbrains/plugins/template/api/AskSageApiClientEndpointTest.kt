...
class AskSageApiClientEndpointTest : BasePlatformTestCase() {
    ...
    fun testOpenAiChatCompletionsSuccess() {
        ...
        val request = org.jetbrains.plugins.template.api.models.OpenAiChatRequest(
            model = "gpt-4",
            messages = listOf(org.jetbrains.plugins.template.api.models.OpenAiChatMessage("user", "Hello")),
        )
    ...
    fun testAnthropicMessagesSuccess() {
        ...
        val request = org.jetbrains.plugins.template.api.models.AnthropicRequest(
            model = "claude-3-opus",
            messages = listOf(org.jetbrains.plugins.template.api.models.AnthropicMessage("user", "Hello")),
        )
    ...
    fun testQueryWithSystemPrompt() {
        ...
        val queryRequest = org.jetbrains.plugins.template.api.models.QueryRequest(
            model = "gpt-4",
