...
class ApiModelsTest : TestCase() {
    ...
    fun testChatMessageRole() {
        val roles = org.jetbrains.plugins.template.services.MessageRole.entries
        assertEquals(3, roles.size)
        assertTrue(roles.contains(org.jetbrains.plugins.template.services.MessageRole.USER))
        assertTrue(roles.contains(org.jetbrains.plugins.template.services.MessageRole.ASSISTANT))
        assertTrue(roles.contains(org.jetbrains.plugins.template.services.MessageRole.ERROR))
    }
}
