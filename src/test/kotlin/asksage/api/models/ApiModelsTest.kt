...
class ApiModelsTest : TestCase() {
    ...
    fun testChatMessageRole() {
        val roles = asksage.services.MessageRole.entries
        assertEquals(3, roles.size)
        assertTrue(roles.contains(asksage.services.MessageRole.USER))
        assertTrue(roles.contains(asksage.services.MessageRole.ASSISTANT))
        assertTrue(roles.contains(asksage.services.MessageRole.ERROR))
    }
}
